            ...
            <nav className="sticky top-8 flex flex-col h-[calc(100vh-8rem)] p-2 justify-between">
                ...
                {navItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "w-full flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-colors cursor-pointer",
              ...
              <div className="mt-4">
                <button
                  ...
                  onClick={() =>
                    window.open(
                      "https://github.com/Amit-Kumar015/New-Flashcard-App/issues",
                      "_blank",
                    )
                  }
                >
